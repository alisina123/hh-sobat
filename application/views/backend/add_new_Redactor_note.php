...
<div class="header">
    <center><h4 class="title"><?=lang('add_new_note')?></h4></center>
</div>                                                                    
<div class="row">
     <form method="POST" action="<?=site_url('backend/addNewRedactorNote')?>" enctype="multipart/form-data" onsubmit="javascript: void(0);loadAjax();">
            ...
            <div class="col-sm-12">
                   <div class="form-group">
                      ...
                      <textarea class="form-control ckeditor" rows="6"  name="content" id="editor1" required style="max-width: 100%;"></textarea>
                      <?=form_error('content');?>
                    </div> 
         </div>
