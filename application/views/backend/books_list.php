    ...
    <div class="col-sm-6">                  
        <div class="form-group input-group">
            ...
            <div class="input-group-btn">
                <button class="btn btn-fill btn-info" onclick="makeSearch('<?=site_url("backend/booksList/".$id)?>','SearchForm','searchResult');" type="button"><i class="fa fa-search"></i><?=lang('search')?></button>
            </div> 
        </div> 
    </div>
     <?php
