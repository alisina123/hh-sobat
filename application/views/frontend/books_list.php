    ...
    <div class="col-sm-12">                  
        <div class="form-group input-group">
            ...
            <div class="input-group-btn">
                <button class="btn btn-fill btn-info" onclick="makeSearch('<?=site_url("main/booksList/".$id)?>','SearchForm','searchResult');" type="button"><i class="fa fa-search"></i><?=lang('search')?></button>
            </div> 
        </div> 
    </div>
     <?php
